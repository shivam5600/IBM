...
def pie(site_dropdown):
    if site_dropdown == 'All Sites':
        ...
        pie_fig = px.pie(class_pie, values='class count', names='class', title="Total success launches for site: " + site_dropdown)
        return pie_fig
...
def scatter(site_dropdown,slider_range):
    ...
    if site_dropdown == 'All Sites':
        ...
        scatter_fig = px.scatter(filtered_scatter, x="Payload Mass (kg)", y="class", color="Booster Version Category", title='Payload Success Rate for Site: ' + site_dropdown)
